...
import { imageUpload } from "../../components/api/utilities";
...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // update user profile( username, photourl)
        ...
        >
          ...
          <div>
            <button
              disabled={loading}
              type="submit"
              className="bg-rose-500 w-full disabled:cursor-not-allowed  rounded-md py-3 text-white"
            >
              {loading ? (
